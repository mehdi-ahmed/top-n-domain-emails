...
import static com.kahoot.interview.email.util.EmailUtil.EMAILS_OUTPUT_CSV;
...
public class TopEmailDomainsMain {
    ...
    private static final Logger LOGGER = Logger.getLogger(TopEmailDomainsMain.class.getName());
